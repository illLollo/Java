...
public class ConnectionManager implements Closeable
{
    ...
    public void bindListen(final int port) throws SocketException
    {
        if (this.listenSocket != null)
            throw new IllegalStateException("Socket alreay binded to port " + this.listenSocket.getLocalPort());
        this.listenSocket = new DatagramSocket(port);
    }
